Attribute VB_Name = "md_reg_dll"
'**************************************
' Name: ActiveX Dll Register/UnRegister
' Description:This code shows how to reg
'     ister and unregister ActiveX dlls progra
'     matically, without relying on regsvr32 f
'     or the task. It's built into a reuseable
'     class that can be put in your own code o
'     r compiled into a dll. Based very loosel
'     y on code from Vasudevan S.
' By: Robert J May
'
' Inputs:The file name
'
' Returns:7 flags. See the enumeration a
'     nd sample code for details.
'
'This code is copyrighted and has' limited warranties.Please see http://w
'     ww.Planet-Source-Code.com/vb/scripts/Sho
'     wCode.asp?txtCodeId=46775&lngWId=1'for details.'**************************************
